...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ToolBar_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 54, 4)
    ...
    "ToolBar\0eventTriggered\0\0QEvent*\0ev\0"
    "folderDropped\0name\0path"
};
...
void ToolBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->folderDropped((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (ToolBar::*_t)(QEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ToolBar::eventTriggered)) {
                *result = 0;
            }
        }
        {
            typedef void (ToolBar::*_t)(QString , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ToolBar::folderDropped)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void ToolBar::eventTriggered(QEvent * _t1)
{
...
// SIGNAL 1
void ToolBar::folderDropped(QString _t1, QString _t2)
{
