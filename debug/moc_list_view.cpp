/****************************************************************************
** Meta object code from reading C++ file 'list_view.h'
**
...
#error "The header file 'list_view.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ListView_t, stringdata) + ofs \
...
const QMetaObject ListView::staticMetaObject = {
    { &View::staticMetaObject, qt_meta_stringdata_ListView.data,
      qt_meta_data_ListView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ListView.stringdata))
