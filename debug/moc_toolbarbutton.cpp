...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ToolbarButton_t, stringdata) + ofs \
...
const QMetaObject ToolbarButton::staticMetaObject = {
    { &QToolButton::staticMetaObject, qt_meta_stringdata_ToolbarButton.data,
      qt_meta_data_ToolbarButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ToolbarButton.stringdata))
