/****************************************************************************
** Meta object code from reading C++ file 'custom_network_access_manager.h'
**
...
#error "The header file 'custom_network_access_manager.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CustomNetworkAccessManager_t, stringdata) + ofs \
...
const QMetaObject CustomNetworkAccessManager::staticMetaObject = {
    { &QNetworkAccessManager::staticMetaObject, qt_meta_stringdata_CustomNetworkAccessManager.data,
      qt_meta_data_CustomNetworkAccessManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CustomNetworkAccessManager.stringdata))
