...
QT_MOC_LITERAL(11, 114, 27),
QT_MOC_LITERAL(12, 142, 7),
QT_MOC_LITERAL(13, 150, 14)
    },
    "Download\0slotChanged\0\0message\0"
    "downloadProgress\0ModelItem*\0item\0"
    "percentDone\0downloadFinished\0success\0"
    "downloadError\0downloadConnectionResponsed\0"
    "onTimer\0finishDownload"
};
...
void Download::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->slotChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->downloadProgress((*reinterpret_cast< ModelItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->downloadFinished((*reinterpret_cast< ModelItem*(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        case 3: _t->downloadError((*reinterpret_cast< ModelItem*(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 4: _t->downloadConnectionResponsed(); break;
        ...
        {
            typedef void (Download::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Download::slotChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (Download::*_t)(ModelItem * , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Download::downloadProgress)) {
                *result = 1;
            }
        }
        {
            typedef void (Download::*_t)(ModelItem * , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Download::downloadFinished)) {
                *result = 2;
            }
        }
        {
            typedef void (Download::*_t)(ModelItem * , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Download::downloadError)) {
                *result = 3;
            }
        }
    }
...
// SIGNAL 0
void Download::slotChanged(QString _t1)
{
...
// SIGNAL 1
void Download::downloadProgress(ModelItem * _t1, int _t2)
{
...
// SIGNAL 2
void Download::downloadFinished(ModelItem * _t1, bool _t2)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
...
// SIGNAL 3
void Download::downloadError(ModelItem * _t1, QString _t2)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
