...
public:
    ...
    VideoBuffer(QImage * img, int width, int height, AVPixelFormat format) : av_picture(0) {
        fmt = format;
        buff_width = width;
        buff_height = height;
        q_image = img;
    ...
    VideoBuffer(AVPicture * pict, int width, int height, AVPixelFormat format) : q_image(0) {
        fmt = format;
        buff_width = width;
        buff_height = height;
        av_picture = pict;
