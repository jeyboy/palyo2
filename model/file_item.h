...
public:
    ...
    FileItem(const QString filepath, ModelItem *parent = 0, int genre_id = -1, int itemDuration = -1, int itemSize = -1, QString itemInfo = "", int init_state = STATE_DEFAULT | STATE_CHECKED);
    ~FileItem();
